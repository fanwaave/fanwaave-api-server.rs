#![forbid(unsafe_code)]
//! Serving the four avenues from `fanwaave-api-server`.
//!
...
//! |---|------|---------------------|
//! | 1 | `direct_read` | none: the web server reads Postgres itself through `fanwaave-lib-core` |
...
///
/// Bind `FANWAAVE_API_MTLS_ADDR` and pass the listener. One task per
