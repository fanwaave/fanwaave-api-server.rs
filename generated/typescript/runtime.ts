...
export function loadEnvMap(
  ...
  const fanwaave_api_bind = pick(["FANWAAVE_API_BIND"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (fanwaave_api_bind !== undefined) out["FANWAAVE_API_BIND"] = fanwaave_api_bind;
  const fanwaave_api_tcp_bind = pick(["FANWAAVE_API_TCP_BIND"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (fanwaave_api_tcp_bind !== undefined) out["FANWAAVE_API_TCP_BIND"] = fanwaave_api_tcp_bind;
  const fanwaave_nats_url = pick(["FANWAAVE_NATS_URL"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (fanwaave_nats_url !== undefined) out["FANWAAVE_NATS_URL"] = fanwaave_nats_url;
